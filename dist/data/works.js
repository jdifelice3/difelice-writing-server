...
export const Works = z.array(WorkSchema).parse([
    ...
    },
    {
        id: '17',
        title: 'Balk!',
        description: 'BALK! follows a lifelong underdog, a 32-year-old journeyman pitcher making his Major League debut in the highest-stakes situation the game can offer: bases loaded, tie game, season on the line. As he walks to the mound, the moment triggers a cascade of memories, regrets, sacrifices, and the crushing weight of other people’s dreams. What begins as a classic sports drama slowly transforms into an intimate psychological portrait of ambition, identity, and inherited pressure. With escalating tension, the story builds toward a shocking, unforgettable act that rewrites the meaning of winning, losing, and control.',
        form: Form.Enum['short story'],
        wordCount: 0,
        pageCount: 0,
        genre: Genre.enum.literary,
